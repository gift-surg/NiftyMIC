...
import niftymic.reconstruction.solver.DifferentialOperations as diffop
...
class TestDifferentialOperations(unittest.TestCase):
    ...
    def test_adjoint_differentiation_convolution_mode_wrap(self):
        ...
        differential_operations = diffop.DifferentialOperations(step_size=0.5, convolution_mode='wrap')
    ...
    def test_adjoint_differentiation_convolution_mode_constant(self):
        ...
        differential_operations = diffop.DifferentialOperations(step_size=0.5, convolution_mode='constant')
    ...
    #  for the Laplace stencil computation. Periodic boundary conditions are chosen
    def test_Laplace_stencil_convolution_mode_wrap(self):
        ...
        differential_operations = diffop.DifferentialOperations(step_size=1, Laplace_comp_type="LaplaceStencil", convolution_mode='wrap')
    ...
    def test_Laplace_stencil_convolution_mode_constant(self):
        ...
        differential_operations = diffop.DifferentialOperations(step_size=1, Laplace_comp_type="LaplaceStencil", convolution_mode='constant')
