...
class TestRegistrationITK(unittest.TestCase):
    ...
    def test_inplane3Dsimilarity_registration(self):
        ...
        stack_corrupted_sitk = sitkh.get_transformed_sitk_image(stack.sitk, motion_sitk)
        stack_corrupted_sitk_mask = sitkh.get_transformed_sitk_image(stack.sitk_mask, motion_sitk)
