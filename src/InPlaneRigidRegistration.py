...
class InPlaneRigidRegistration:
    ...
    def _in_plane_rigid_registration_2D(self, fixed_2D_sitk, moving_2D_sitk, fixed_2D_sitk_mask=None, moving_2D_sitk_mask=None):
    ...
    ## Simpy register one slice to the previous one
    def _apply_in_plane_rigid_registration_2D_approach_01_v1(self):
        for i in range(0, self._N_stacks):
            ...
            for j in range(0, N_slices-step):
                ...
                rigid_transform_2D = self._in_plane_rigid_registration_2D_sitk_2D_v1(fixed_2D_sitk, moving_2D_sitk)
                ...
                T_PI_in_plane_rotation_3D = sitkh.get_3D_in_plane_alignment_transform_from_sitk_2D_rigid_transform(rigid_transform_2D_inv, slice_3D.sitk)
    ...
    def _in_plane_rigid_registration_2D_sitk_2D_v1(self, fixed, moving):
        ...
        final_transform_2D = registration_method.Execute(sitk.Cast(fixed, sitk.sitkFloat64), sitk.Cast(moving, sitk.sitkFloat64)) 
