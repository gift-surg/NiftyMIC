...
class SliceAcqusition:
    ...
    def _get_interpolator_oriented_gaussian(self, output_direction_sitk, rigid_motion_transform_itk):
        ...
        Cov_HR_coord = PSF.get_gaussian_PSF_covariance_matrix_reconstruction_coordinates_from_direction_and_spacing(output_transformed_direction_sitk, self._output_spacing, self._HR_volume)
