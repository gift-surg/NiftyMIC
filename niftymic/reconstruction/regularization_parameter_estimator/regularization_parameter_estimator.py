#------------------------------------------------------------------------------
# \file regularization_parameter_estimator.py
...
class RegularizationParameterEstimator(object):
    ...
    ##
    #       Set prefix for all output results written to
    #             directory_results.
    ...
    ##
    #       Gets the filename results directory.
