...
import niftymic.reconstruction.stack_average as sa
...
class HierarchicalSliceAlignment:
    ...
    def _get_rigid_registration_transform(self, fixed_3D, moving_3D, display_registration_info=0):
        ...
        ## Blur 
        Cov_HR_coord = self._psf.get_gaussian_PSF_covariance_matrix_reconstruction_coordinates( fixed_3D, moving_3D )
