...
typedef itk::GradientAffine3DTransformImageFilter<ImageType3D, PixelType, PixelType> FilterType_GradientAffine_3D;


TEST_CASE( "Check GradientAffine3DTransformImageFilter", "[GradientAffine3DTransformImageFilter]"){
    ...
    const FilterType_GradientAffine_3D::Pointer filter_GradientAffine_3D = FilterType_GradientAffine_3D::New();
    filter_GradientAffine_3D->SetTransform(transform);
    filter_GradientAffine_3D->SetInput(slice);
    filter_GradientAffine_3D->Update();
    ...
    AffineTransformType::JacobianType  jacobian2;
    ImageCovariantVectorType::Pointer jacobian_slice = filter_GradientAffine_3D->GetOutput();
    ...
    AffineTransformType::ParametersType parameters(transform->GetNumberOfParameters());
    parameters[0] = 2;
    parameters[1] = 7.5;
    parameters[2] = 0.15;
    parameters[3] = -3.5;
    ...
    filter_GradientAffine_3D->Update();
    // jacobian_slice = filter_GradientAffine_3D->GetOutput();
